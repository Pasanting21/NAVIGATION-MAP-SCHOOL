  ...
  const HOME_BUILDINGS = {
    A: {
      ...
      landmarks: [
        ...
        { name: "Rousseau", type: "Classroom", floor: "4", accessible: true, aliases: ["Room Rousseau"] },
        { name: "Dewey", type: "Classroom", floor: "4", accessible: true, aliases: ["Room Dewey"] },
        { name: "Thoreau", type: "Classroom", floor: "4", accessible: true, aliases: ["Room Thoreau"] },
        { name: "John Locke", type: "Classroom", floor: "4", accessible: true, aliases: ["Room Locke"] },
        { name: "Aristotle", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Aristotle"] },
        { name: "Mill", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Mill"] },
        { name: "Socrates", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Socrates"] },
        { name: "Smith", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Smith"] },
        { name: "Voltaire", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Voltaire"] },
        { name: "Leibniz:", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Leibniz"] },
        { name: "Confucious", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Confucius"] },
        { name: "Emerson", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Emerson"] },
        { name: "Gautama", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Gautama"] },
        { name: "Linclon", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Lincoln"] },
        { name: "Sun Tzu", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Suntzu"] },
        { name: "Michavelli", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Michavelli"] },
        { name: "Marx", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Marx"] },
        { name: "Bill Gates", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Gates"] },
        { name: "Henry Ford", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Ford"] },
        { name: "Larry Page", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Page"] },
        { name: "Stephen Covey", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Covey"] },
        { name: "Elon Musk", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Musk"] }
      ]
    },
    B: {
      code: "B",
      ...
      landmarks: [
        ...
        { name: "Altgeld", type: "Office", floor: "1", accessible: true, aliases: ["Altgeld"] }
      ]
    },
    C: {
      code: "C",
      ...
      accessible: true,
      landmarks: [
        { name: "Computer Lab 1", type: "Lab", floor: "4", accessible: true, aliases: ["Com Lab 1"] },
        { name: "Computer Lab 2", type: "Lab", floor: "4", accessible: true, aliases: ["Com Lab 2"] },
        { name: "Rm.C.403", type: "Classroom", floor: "4", accessible: false, aliases: ["Room C403"] },
        { name: "Newton", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Newton"] },
        { name: "Pythagoras", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Pythagoras"] },
        { name: "Fibonacci", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Fibonacci"] },
        { name: "Ryzen", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Ryzen"] },
        { name: "Haswell", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Haswell"] },
        { name: "Celeron", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Celeron"] },
        { name: "Poulson", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Poulson"] },
        ...
        { name: "Galilie", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Galilie"] },
        { name: "Descartes", type: "Classroom", floor: "2", accessible: true, aliases: ["Room Descartes"] },
        { name: "School Clinic", type: "Facility", floor: "1", accessible: true, aliases: ["Clinic"] },
        { name: "Dalton", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Dalton"] },
        { name: "Einstein", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Einstein"] },
        { name: "Linneaus", type: "Classroom", floor: "1", accessible: true, aliases: ["Room Linneaus"] },
    ...
    D: {
      ...
      landmarks: [
        ...
        { name: "Waterlily", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Waterlily"] },
        { name: "Malakas", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Malakas"] },
        { name: "Matibay", type: "Classroom", floor: "3", accessible: true, aliases: ["Room Matibay"] },
